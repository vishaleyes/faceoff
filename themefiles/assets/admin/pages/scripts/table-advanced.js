var TableAdvanced = function () {
    ...
    var initTable3 = function () {
        ...
        function fnFormatDetails(oTable, nTr) {
            ...
            var sOut = '<table>';
            sOut += '<tr><td>Logbook Name:</td><td>' + aData[1] + '</td></tr>';
            sOut += '<tr><td>Log Date:</td><td>' + aData[2] + '</td></tr>';
            sOut += '<tr><td>Shop Name:</td><td>' + aData[3] + '</td></tr>';
            sOut += '<tr><td>Visibility:</td><td>' + aData[4] + '</td></tr>';
			sOut += '<tr><td>Depth:</td><td>' + aData[5] + '</td></tr>';
			sOut += '<tr><td>Bottomline:</td><td>' + aData[6] + '</td></tr>';
            sOut += '</table>';
