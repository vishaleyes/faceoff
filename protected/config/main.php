...
// CWebApplication properties can be configured here
	...
	//define('FILE_PATH','http://localhost/pos/');	
	...
	$statusFlag=true;
	 ...
	 {	
		...
		if(strtolower($result['controller'])=='admin' || strtolower($result['controller'])=='support' ||
			 strtolower($result['controller'])=='api' || strtolower($result['controller'])=='apidoc')
		{
			$themename = '';
		}
		else
	 ...
	 else
	 {
		...
		if(strtolower($result['controller'])=='admin' || strtolower($result['controller'])=='support' ||
			 strtolower($result['controller'])=='api')
		{
			$themename = "";
		}
		...
		else if(strtolower($result['controller'])=='user')
		{
			$themename = 'faceoff';	
		}
		else
	...
	'params'=>array(
		...
		'base_path'=>'http://'.WEB_HOST_NAME.'/faceoff/index.php?r=',
		'base_url'=>'http://'.WEB_HOST_NAME.'/faceoff/',
		'base_path_language'=>'http://'.WEB_HOST_NAME.'/faceoff/js/',
		'image_path'=>'http://'.WEB_HOST_NAME.'/faceoff/images',
		'msg'=>$msg,
		'adminmsg'=>$adminmsg,
		'errorCode'=>$errorCode,
