	...
	<form class="login-form" method="post" action="<?php echo Yii::app()->params->base_path; ?>admin/AdminLogin">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix required" type="text" autocomplete="off" placeholder="Email" name="email_admin" value="<?php if(isset($_COOKIE['email_admin']) && $_COOKIE['email_admin'] != "0") { echo $_COOKIE['email_admin']; } ?>" />
			</div>
		</div>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9 required">Password</label>
			<div class="input-icon">
				<i class="fa fa-lock"></i>
				<input class="form-control placeholder-no-fix required" type="password" autocomplete="off" placeholder="Password" name="password_admin" value="<?php if(isset($_COOKIE['password_admin']) && $_COOKIE['password_admin'] != "0") { echo $_COOKIE['password_admin']; }?>"/>
			</div>
		</div>
		<div class="form-actions">
			...
			<button type="submit" name="submit_login" class="btn green pull-right">
		...
		<div class="forget-password">
			...
			<p>
				 no worries, click <a href="<?php echo Yii::app()->params->base_path;?>admin/forgotPassword" >
				here </a>
