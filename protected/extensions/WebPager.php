<?php
class webPager extends CLinkPager{
	...
	public function run()
	{
		...
		echo $this->header;
		echo '&nbsp;&nbsp;<img id="paginationLoader" src="images/input-spinner.gif" style="margin-bottom:9px;display:none;"><label float: left;margin-top: 17px;> '.$startRecord.' - '.$endRecord. ' of '.$totalRecord.' </label>&nbsp;&nbsp;';
